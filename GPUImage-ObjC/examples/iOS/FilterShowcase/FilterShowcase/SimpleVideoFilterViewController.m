...
//    videoCamera = [[GPUImageVideoCamera alloc] initWithSessionPreset:AVCaptureSessionPreset1920x1080 cameraPosition:AVCaptureDevicePositionBack];
    ...
    [(GPUImageTiltShiftFilter *)tiltShiftFilter setTopFocusLevel:0.65];
    [(GPUImageTiltShiftFilter *)tiltShiftFilter setBottomFocusLevel:0.85];
    //[(GPUImageTiltShiftFilter *)tiltShiftFilter setBlurSize:1.5];
