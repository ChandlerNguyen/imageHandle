//
//  FeatureExtractionViewController.m
//  FilterShowcase
//
...
@interface FeatureExtractionViewController ()
{
...
@implementation FeatureExtractionViewController
...
- (void)saveImage:(UIImage *)imageToSave fileName:(NSString *)imageName;
{
    [self.view setBackgroundColor:[UIColor colorWithPatternImage:imageToSave]];
    /*
